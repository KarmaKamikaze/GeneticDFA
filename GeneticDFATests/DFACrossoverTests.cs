...
public class DFACrossoverTests
{
    ...
    public void CrossoverMaintainsStateUniqueness()
    {
        ...
        Assert.All(children, c =>
        {
            ...
            Assert.All(chromosome.States, s =>
            {
                Assert.Single(chromosome.States, s2 => s2.Id == s.Id);
            });
        });
    }
    ...
    public void CrossoverMaintainsEdgeIDUniqueness()
    {
        ...
        Assert.All(children, c =>
        {
            ...
            {
                Assert.Single(chromosome.Edges, e2 => e2.Id == e.Id);
            });
        });
    }
    ...
    public void CrossoverMaintainsEdgePropertiesUniqueness()
    {
        ...
        Assert.All(children, c =>
        {
            ...
            Assert.All(chromosome.Edges, e =>
            {
                Assert.Single(chromosome.Edges, e2 => e2.Source == e.Source && e2.Input == e.Input && e2.Target == e.Target);
            });
        });
    }
    ...
    public void CrossoverDoesNotCauseEdgesToPointOutsideTheSetOfStates()
    {
        ...
        Assert.All(children, c =>
        {
            ...
            Assert.All(chromosome.Edges, e =>
            {
                Assert.True(chromosome.States.Contains(e.Source) && chromosome.States.Contains(e.Target));
            });
        });
    }
